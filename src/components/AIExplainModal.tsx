...
export default function AIExplainModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/80 backdrop-blur-md p-0 sm:p-4 animate-fadeIn">
      <div className="bg-slate-900 border-t sm:border border-slate-700 rounded-t-3xl sm:rounded-3xl max-w-2xl w-full p-5 sm:p-6 text-slate-100 shadow-2xl relative max-h-[85vh] sm:max-h-[90vh] overflow-y-auto animate-bottom-sheet sm:animate-none">
